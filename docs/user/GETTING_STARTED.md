# Getting Started with Local Photos

This guide will help you install and set up the Local Photos custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/Migz93/ha-local_photos`
6. Set category to "Integration"
7. Click "Add"
8. Find "Local Photos" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/Migz93/ha-local_photos/releases)
2. Extract the `local_photos` folder from the archive
3. Copy it to `custom_components/local_photos/` in your Home Assistant configuration directory
...
4. Select entities from "Local Photos"
...
- Report issues at [GitHub Issues](https://github.com/Migz93/ha-local_photos/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/Migz93/ha-local_photos/discussions)

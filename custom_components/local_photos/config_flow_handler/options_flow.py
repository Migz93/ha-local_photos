...
class LocalPhotosOptionsFlow(config_entries.OptionsFlow):
    ...
    async def async_step_init(
        ...
        current_maximum_file_size = self.config_entry.options.get(
            CONF_MAXIMUM_FILE_SIZE,
            SETTING_MAXIMUM_FILE_SIZE_DEFAULT_OPTION,
        )
        ...
        if user_input is not None:
            ...
            try:
                ...
                self.maximum_file_size = user_input[CONF_MAXIMUM_FILE_SIZE]
                ...
                current_maximum_file_size = user_input[CONF_MAXIMUM_FILE_SIZE]

        return self.async_show_form(
            step_id="init",
            data_schema=get_options_folder_schema(current_folder_path, current_maximum_file_size),
            errors=errors,
        )
    ...
    async def async_step_album_select(
        ...
        updated_options = {
            **self.config_entry.options,
            ...
            CONF_MAXIMUM_FILE_SIZE: self.maximum_file_size,
        }

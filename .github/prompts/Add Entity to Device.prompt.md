...
- Inherit from `LocalPhotosEntity` and platform base class
...
- Entity: `custom_components/local_photos/[platform]/[entity_name].py`
- Platform: `custom_components/local_photos/[platform]/__init__.py`

...
**File:** `custom_components/local_photos/services.yaml`
...
Create `custom_components/local_photos/service_actions/[action_name].py`:

```python
"""[Action name] service action for Local Photos."""
...
**File:** `custom_components/local_photos/__init__.py`
...
**File:** `custom_components/local_photos/const.py`
...
3. Find service action: `local_photos.[action_name]`
...
- **Domain:** `local_photos`
- **Service actions directory:** `custom_components/local_photos/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/local_photos/services.yaml` (legacy filename)
- **Icons:** `custom_components/local_photos/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/local_photos/translations/*.json` under `services` key (legacy)

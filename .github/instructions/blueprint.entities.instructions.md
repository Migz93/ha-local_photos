...
- **`entity/`** - Base entity classes (inherit `LocalPhotosEntity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, LocalPhotosEntity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import LocalPhotosEntity`

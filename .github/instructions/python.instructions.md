...
- Files: `snake_case.py`
- Classes: `PascalCase` prefixed with `LocalPhotos`
...
- Inherit from both platform entity and `LocalPhotosEntity` (order matters)
...
from custom_components.local_photos.sensor import async_setup_entry
...
**Config entry data:** `entry_data: LocalPhotosData = hass.data[DOMAIN][entry.entry_id]`

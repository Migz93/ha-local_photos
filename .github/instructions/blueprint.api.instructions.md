...
- `LocalPhotosApiClientError` (Base)
- `LocalPhotosApiClientCommunicationError` (Network, timeout, HTTP errors)
- `LocalPhotosApiClientAuthenticationError` (401, 403, invalid credentials)

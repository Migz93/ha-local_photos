...
- **Main code:** `custom_components/local_photos/`
...
- `entity/` — Base entity class (`LocalPhotosEntity`)
...
- Entity MRO: `(PlatformEntity, LocalPhotosEntity)` — order matters
...
- Debug level: `custom_components.local_photos: debug` in `config/configuration.yaml`
